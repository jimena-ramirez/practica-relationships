...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { description: @computer.description, marca_id: @computer.marca_id, name: @computer.name, price: @computer.price } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { description: @computer.description, marca_id: @computer.marca_id, name: @computer.name, price: @computer.price } }
